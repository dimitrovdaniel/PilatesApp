...
//        "http://52.211.65.199:8080/provider/api/v1/user/login",  // aws provider ip
//        "http://192.168.33.31:8080/provider/api/v1/user/login", // local work signaling ip
...
//                    "http://192.168.33.31:8081/provider/api/v1/user/login",
